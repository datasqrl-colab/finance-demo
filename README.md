...
Both data products consume the shared [`data-catalog`](https://github.com/datasqrl-colab/finance-data-catalog-demo) — a git submodule at the repository root — via `script.include` in their shared package files. Clone with submodules:
